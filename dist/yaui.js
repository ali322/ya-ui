...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var GoTop = __webpack_require__(179);
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement('span', { className: "icon iconfont icon-top" })
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = React.createFactory(__webpack_require__(187));
	var ReactCSSTransitionGroupChild = React.createFactory(__webpack_require__(192));
...
/***/ function(module, exports) {
	...
	'use strict';
	var bindListener = window.addEventListener ? 'addEventListener' : 'attachEvent';
	var unbindListener = window.removeEventListener ? 'removeEventListener' : 'detachEvent';
	var eventNamePrefix = bindListener === 'addEventListener' ? '' : 'on';

	var Event = {
	    bind: function bind(domNode, eventName, eventListener) {
	    ...
	    unbind: function unbind(domNode, eventName, eventListener) {
	        var capture = arguments.length <= 3 || arguments[3] === undefined ? false : arguments[3];
